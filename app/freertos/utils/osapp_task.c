...
#define APP_TASK_STACK_SIZE                     500 //it is 500 original-by ning 2019-05-24
...
__attribute__ ((weak)) void app_adc_util_init(void)
{
...
void osapp_task(void *params)
{
    ...
    queued_async_call_func_set(osapp_async_call_wrapper);
    app_adc_util_init();
    user_init();
    while(1)
    {
