...
// RF Freq.(MHz): 467.5    API_TC: 29    fhst: 200000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
...
#define RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH              0xFB
#define RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP       0x03
#define RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET      0xF000
#define RADIO_CONFIGURATION_DATA_CUSTOM_LONG_PAYLOAD			{}
...
#define RF_POWER_UP 0x02, 0x81, 0x00, 0x01, 0xC9, 0xC3, 0x80//patch

/*
// Command:                  RF_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_GPIO_PIN_CFG 0x13, 0x15, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x00
...
*/
#define XO_TUNE 0x41
#define RF_GLOBAL_XO_TUNE_1 0x11, 0x00, 0x01, 0x00, XO_TUNE
#define crystal_XO_TUNE (0x67-XO_TUNE)
/*
...
*/
#define RF_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x07, 0x3B, 0x03, 0x08
//#define RF_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x01, 0x19, 0x00, 0x00  //NEW--rx
//#define RF_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x01, 0x3B, 0x00, 0x00  //NEW--tx
...
*/
//#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x50, 0x14, 0x00, 0x0F, 0x12, 0x00, 0x00, 0x00, 0x00
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x20, 0x0E, 0x00, 0x0F, 0x12, 0x00, 0x00, 0x00, 0x00
...
*/
//#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x01, 0x19, 0xCF, 0x00, 0x00 //98 f3
//#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x01, 0x2C, 0x42, 0x00, 0x00 //34 42
//#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x01, 0x98, 0xF3, 0x00, 0x00 //98 f3
#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x01, 0x89, 0x42, 0x00, 0x00 //89 42
...
#define RF_PKT_CRC_CONFIG_1 0x11, 0x12, 0x01, 0x00, 0x83 //NEW
...
*/
//#define RF_PKT_WHT_SEED_15_8_4 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x12 //MSB
//#define RF_PKT_WHT_SEED_15_8_4 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x82 //NEW  MSB
#define RF_PKT_WHT_SEED_15_8_4 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x81 //LSB
...
*/
//#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x2A, 0x01, 0xFF, 0x30, 0x30, 0x00, 0x01, 0x00, 0x00, 0x00, 0xF9, 0x00
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x26, 0x01, 0x00, 0x30, 0x30, 0x00, 0x01, 0x04, 0x80, 0x00, 0xFF, 0x00//NEW  
//#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x22, 0x01, 0xFF, 0x30, 0x30, 0x00, 0x01, 0x00, 0x00, 0x00, 0xF9, 0x00//NEW  0xFF==-1
#define RF_PKT_RX_FIELD_1_LENGTH_4 0x11, 0x12, 0x04, 0x21, 0x00, 0x01, 0x00, 0x00 //NEW
#define RF_PKT_RX_FIELD_2_LENGTH_4 0x11, 0x12, 0x04, 0x25, 0x00, 0xFF, 0x00, 0x00 //NEW  PKT_RX_FIELD_2_CRC_CONFIG
...
*/
//#define RF_MODEM_OOK_CNT1_11 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xD8, 0x01, 0x80, 0xFF, 0x0C, 0x21
#define RF_MODEM_OOK_CNT1_11 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xD8, 0x01, 0x80, 0xFF, 0x0C, 0x12//NEW
...
*/
//#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x0D, 0x55, 0x55, 0x36, 0x9D, 0x20, 0xFE //470
//#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x0A, 0xAA, 0xAA, 0x36, 0x9D, 0x20, 0xFE   //476.5
//#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3E, 0x0B, 0x25, 0x8B, 0x36, 0x9D, 0x20, 0xFE  //475.45
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x0E, 0xEE, 0xEE, 0x36, 0x9D, 0x20, 0xFE  //471.5
...
#define RADIO_CONFIGURATION_DATA_ARRAY { \
        ...
        0x08, RF_PKT_RX_FIELD_1_LENGTH_4, \
        0x08, RF_PKT_RX_FIELD_2_LENGTH_4, \
        0x00 \
 }
#else
