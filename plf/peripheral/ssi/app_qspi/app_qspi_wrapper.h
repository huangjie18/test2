...
void app_qspi_param_init_wrapper(void);
...
periph_err_t app_qspi_multi_read_32bits_wrapper(qspi_multi_read_32bits_param_t *param);

periph_err_t app_qspi_config_for_cache_wrapper(qspi_multi_read_32bits_param_t *param);
