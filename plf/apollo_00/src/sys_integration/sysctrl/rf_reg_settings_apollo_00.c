...
void rf_setPA_0dbm(void)
{
    ...
    hwp_rf_reg->rf_reg_c.VDD_RF2_Regulator_Voltage_3V = 7;//0;//change by ljj 20190830
...
//    hwp_rf_reg->rf_reg_d.DTS_VCTL = 0;
    ...
    hwp_rf_reg->rf_reg_d.VCTL_0PA = 7;//2;		//change by ljj 20190830	
    hwp_rf_reg->rf_reg_d.ISEL_0PA = 0;
    hwp_rf_reg->rf_reg_d.ICTL_PA2 = 7;//3;		//change by ljj 20190830	
    hwp_rf_reg->rf_reg_d.ICTL_PA1 = 7;//2;		//change by ljj 20190830	
}
...
//void rf_reg_adjust_temp(uint16_t temp)
//{
...
void rf_reg_settings_init_mp_GitWiz()
{
    ...
    if(AHB_CLK<= 32000000 )
    {
        ...
        hwp_rf_reg->rf_reg_1.DCDC_Output_TX = DCDC_OUTPUT_1V3;//DCDC_OUTPUT_1V4;
        hwp_rf_reg->rf_reg_1.DCDC_Output_RX = DCDC_OUTPUT_1V3;//DCDC_OUTPUT_1V4;
    }
    #endif
...
void rf_reg_settings_init_mp()
{
    ...
    hwp_rf_reg->rf_reg_4.VDD_3V_1_Tr_enhance = 1;
    hwp_rf_reg->rf_reg_6.VDD_3V_2_Tr_enhance = 1;
	hwp_rf_reg->rf_reg_6.LV_32K = 0;    //    hwp_rf_reg->rf_reg_6.LV_32K = 1;				//change by ljj 20190830					
    #endif
	#endif	//add 2190722
    hwp_rf_reg->rf_reg_6.Slow_Clock_Current =4 ;
    ...
    hwp_rf_reg->rf_reg_a.LNA_V_Contro = 4;      //hwp_rf_reg->rf_reg_a.LNA_V_Contro = 0;		//change by ljj 20190830
    hwp_rf_reg->rf_reg_a.LNA_V_Control_EN = 1;	//hwp_rf_reg->rf_reg_a.LNA_V_Control_EN = 0;    //change by ljj 20190830
    hwp_rf_reg->rf_reg_a.LNA_I_Control_1 = 2;
    hwp_rf_reg->rf_reg_a.LNA_I_Control_2 = 3;
    hwp_rf_reg->rf_reg_a.LNA_CA = 3;//hwp_rf_reg->rf_reg_a.LNA_CA = 4;   //change by ljj 20190830
    hwp_rf_reg->rf_reg_a.LNA_V_SEL = 0;
    hwp_rf_reg->rf_reg_a.LNA_I_SEL = 0;
    hwp_rf_reg->rf_reg_a.LNA_Gain_Control = 0;
    hwp_rf_reg->rf_reg_a.R1_RX_2Mbps = 1;
    ...
    hwp_rf_reg->rf_reg_b.VDD_BUF_Reg_Bypass = 0;
    hwp_rf_reg->rf_reg_b.VDD_PLL_Reg_Bypass = 0;
    hwp_rf_reg->rf_reg_b.VDD_VCO_Regulator_Voltage = 0; //0;
    hwp_rf_reg->rf_reg_b.VDD_Div2_Regulator_Voltage = 3;//1;	 //change by ljj 20190830		
    hwp_rf_reg->rf_reg_b.VDD_PLL_Regulator_Voltage = 1;//2;
    hwp_rf_reg->rf_reg_b.VDD_CP_Regulator_Voltage = 0;
	hwp_rf_reg->rf_reg_b.VDD_RF_Regulator_Voltage = 3;//2;  //change by ljj 20190830
    hwp_rf_reg->rf_reg_b.VDD_A_Regulator_Voltage = 1;
    hwp_rf_reg->rf_reg_b.VDD_BUF_Regulator_Voltage = 0;
    hwp_rf_reg->rf_reg_b.R2_TX_2Mbps = 6;
    hwp_rf_reg->rf_reg_b.C2_TX_2Mbps = 6;
    ...
    hwp_rf_reg->rf_reg_e.VCO_Current_for_TX = 6;//1;
    hwp_rf_reg->rf_reg_e.VCO_Current_for_RX = 3;//1;
    hwp_rf_reg->rf_reg_e.VCO_Buffer_Current_for_TX = 6;//3;
    hwp_rf_reg->rf_reg_e.VCO_Buffer_Current_for_RX = 3;//1;
    hwp_rf_reg->rf_reg_e.Divide_by_2_current_for_TX = 7;//4;
    hwp_rf_reg->rf_reg_e.Divide_by_2_current_for_RX = 5;//4;
    hwp_rf_reg->rf_reg_e.LO_Buffer_current_TX = 7;
    hwp_rf_reg->rf_reg_e.LO_Buffer_current_RX = 7;
    hwp_rf_reg->rf_reg_e.DM_Sync_LP = 0;
    hwp_rf_reg->rf_reg_e.DM_Sync_HP = 1;
...
//    if(0==jmesh_ble_get_dbm()){
//        rf_setPA_0dbm();
//    }
//    else{
//        rf_setPA_8dbm();
//    }
		#ifdef BLE_TX_Power_8dbm
		rf_setPA_8dbm();
		#endif
		#ifdef BLE_TX_Power_0dbm
		rf_setPA_0dbm();
		#endif
}
