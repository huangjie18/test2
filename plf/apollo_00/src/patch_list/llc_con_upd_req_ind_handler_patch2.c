...
int llc_con_upd_req_ind_handler_patch2(ke_msg_id_t const msgid,
...
void llc_con_upd_req_ind_handler2_init(void)
{
    uint8_t patch_no[1];
    ...
    patch_entrance_exit_addr(patch_no[0],0x1ea60,(uint32_t)llc_con_upd_req_ind_handler_patch2);
